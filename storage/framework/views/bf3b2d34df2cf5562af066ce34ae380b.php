...
<html lang="en">
    <head>
        ...
        <!-- title -->
        <title><?php echo $__env->yieldContent('title', 'ReturnPal'); ?></title>
        <!-- favicon -->
    ...
    <body>
                    ...
                    <div class="container position-relative">
                        ...
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar">
                            <div class="offcanvas-header">
                                <a href="<?php echo e(url('/')); ?>" class="offcanvas-brand" id="offcanvasNavbarLabel">
                            ...
                            <div class="offcanvas-body">
                                <ul class="navbar-nav justify-content-end flex-grow-1">
                                    <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/#our-solution')); ?>">How It Works</a></li>
                                ...
                                <div class="nav-right">
                                    <div class="nav-btn">
                                        <a href="<?php echo e(route('login')); ?>" class="theme-btn">Get Started Free</a>
                                    </div>
                                    <button
                                        type="button"
        ...
        <div class="sidebar-popup offcanvas offcanvas-end" tabindex="-1" id="sidebarPopup">
            <div class="offcanvas-header">
                <a href="<?php echo e(url('/')); ?>" class="sidebar-popup-logo">
                    <img src="<?php echo e(asset('assets/img/logo/logo.png')); ?>" alt="" />
                </a>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close">
                    <i class="far fa-xmark"></i>
        ...
        <footer class="footer-area">
            <div class="footer-shape">
                <img src="<?php echo e(asset('assets/img/shape/05.png')); ?>" alt="" />
            </div>
                            ...
                            <div class="col-6 col-lg-4">
                                <div class="footer-widget-box list ms-lg-5">
                                    ...
                                    <ul class="footer-list">
                                        <li>
                                            <a href="<?php echo e(url('/#our-solution')); ?>"
                                                ><i class="far fa-angle-double-right"></i>Our Solution</a
                                            >
                                        </li>
                                        <li>
                                            <a href="<?php echo e(url('/#features')); ?>"><i class="far fa-angle-double-right"></i>Features</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(url('/#pricing')); ?>"><i class="far fa-angle-double-right"></i>Pricing</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(url('/#contact')); ?>"><i class="far fa-angle-double-right"></i>Contact Us</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<?php /**PATH /home/runner/work/returnpals/returnpals/resources/views/layouts/app.blade.php ENDPATH**/ ?>