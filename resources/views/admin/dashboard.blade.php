            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h4 class="fw-semibold fs-24 mb-1">{{ $totalUsers }}</h4>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h4 class="fw-semibold fs-24 mb-1">{{ $totalAdmins }}</h4>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h4 class="fw-semibold fs-24 mb-1">{{ $newUsersLast7Days }}</h4>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h4 class="fw-semibold fs-24 mb-1">{{ $totalPackages }}</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h4 class="fw-semibold fs-24 mb-1">{{ $totalPendingItems }}</h4>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        <a href="{{ route('dashboard.overview') }}" class="btn btn-outline-primary">
